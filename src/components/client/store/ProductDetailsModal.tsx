        ...
        <section className="flex min-w-0 flex-col">
          ...
          {isProduct && item.controle_estoque && (
            <div
              ...
              className={`mt-6 flex items-center gap-2 rounded-xl border px-3.5 py-3 text-xs font-bold ${
                outOfStock
          ...
          <div data-store-trust-section className="mt-3 grid gap-2.5 sm:grid-cols-2">

...
<<<<<<< HEAD
  const exportar = async () => {
    ...
    setIsExporting(true);
    try {
      await exportarExcel((dados?.mov||[]).map((m:any)=>({ tipo:m.tipo, pontos:m.pontos, valor_convertido:m.valor_convertido||'—', data:m.data_movimentacao })),'relatorio_gamificacao');
    } finally {

...
print("UPDATING MEDIA ITEM:")
res = query("update gsa_tv_media_items set state='ready' where id='media-auto-ac56ae82-85dd-4ea2-98ef-6751bd3a9daf' returning id, state")

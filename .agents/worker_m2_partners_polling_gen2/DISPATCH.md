## 2026-08-26T14:40:35Z
You are worker_m2_partners_polling_gen2.
...
- For Partners (R2): Ensure `PartnersPage.tsx`, `FornecedoresSection.tsx`, `PartnersAdminModule.tsx` subscribe to `parceiros` and update on insert/update/delete.

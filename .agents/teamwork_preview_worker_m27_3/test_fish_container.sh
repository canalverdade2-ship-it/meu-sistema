#!/usr/bin/env bash
mkdir -p /opt/gsa-tv/cache/media/1/production/secrets
cp /home/opc/gsa-ai/secrets/fish-production.enc.json /opt/gsa-tv/cache/media/1/production/secrets/fish-production.enc.json
chmod 644 /opt/gsa-tv/cache/media/1/production/secrets/fish-production.enc.json

docker exec -i gsa-tv-control-plane node - <<'EOF'
const fs = require('fs');
const crypto = require('crypto');

const vaultPath = '/media/1/production/secrets/fish-production.enc.json';

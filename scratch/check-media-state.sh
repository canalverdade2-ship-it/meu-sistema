...
rows = query("select id, state, approval_state, rights_ok, drive_path, duration_s from gsa_tv_media_items where id='media-auto-ac56ae82-85dd-4ea2-98ef-6751bd3a9daf'")
print('MEDIA ROW:', rows)
EOF

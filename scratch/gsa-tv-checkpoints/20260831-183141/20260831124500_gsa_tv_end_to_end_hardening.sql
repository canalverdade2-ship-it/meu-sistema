...
BEGIN
  ...
  ELSIF v_action='enqueue_job' THEN
    ...
    IF v_job_type NOT IN ('compile_playlist','cache_warmup','cache_cleanup','probe_media','validate_schedule','playout_reload','health_check','stream_start','stream_pause','stream_resume','stream_stop','credentials_check') THEN

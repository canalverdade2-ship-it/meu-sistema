...
VACUUM ANALYZE public.ticket_mensagens;
VACUUM ANALYZE public.saques;
VACUUM ANALYZE public.faturas;
VACUUM ANALYZE public.pontos_movimentacoes;
VACUUM ANALYZE public.extrato_financeiro;
VACUUM ANALYZE public.vouchers;
SELECT relname, n_live_tup, n_dead_tup, last_vacuum, last_analyze
FROM pg_stat_user_tables
WHERE relname IN ('tickets', 'ticket_mensagens', 'saques', 'faturas', 'pontos_movimentacoes', 'extrato_financeiro', 'vouchers')
ORDER BY relname;
`);

...
media = query("select id, title, state, approval_state, rights_ok, duration_s, drive_path from gsa_tv_media_items where id='media-auto-ac56ae82-85dd-4ea2-98ef-6751bd3a9daf'")
print('MEDIA:', json.dumps(media, indent=2))

qc_files = subprocess.run(['ls', '-la', '/opt/gsa-tv/cache/media/1/production/autonomous/2026-09-15/'], capture_output=True, text=True)
print('FILES IN AUTONOMOUS DIR:\n', qc_files.stdout)

...
rows = query("select id, title, state, approval_state, rights_ok, drive_path, duration_s, created_at, updated_at, metadata from gsa_tv_media_items where id='media-auto-ac56ae82-85dd-4ea2-98ef-6751bd3a9daf'")
print('FULL MEDIA ROW:', json.dumps(rows, indent=2, default=str))
EOF

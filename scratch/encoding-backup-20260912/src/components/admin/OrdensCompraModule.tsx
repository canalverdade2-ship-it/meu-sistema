        ...
        <div className="rounded-3xl bg-indigo-50/50 p-6 md:p-8 border border-indigo-100 space-y-6">
          ...
          {isPaid ? (
            <div className="space-y-2 pt-2">
              ...
              >
                <option value="pago">ðŸ“¦ Pedido Aprovado (Pago)</option>
                <option value="em_expedicao">ðŸ“¦ Em Expedição</option>
                <option value="em_transporte">ðŸšš Em Transporte</option>
            ...
            <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl">
              <p className="text-xs text-amber-800 font-bold leading-normal">
                ðŸ”’ O controle de status de logística está bloqueado até que o pagamento da fatura seja confirmado.
              </p>
            </div>
          )}

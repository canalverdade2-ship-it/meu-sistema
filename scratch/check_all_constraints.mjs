...
FROM pg_constraint 
WHERE conrelid IN ('public.tickets'::regclass, 'public.ticket_mensagens'::regclass, 'public.saques'::regclass, 'public.faturas'::regclass, 'public.pontos_movimentacoes'::regclass, 'public.extrato_financeiro'::regclass, 'public.vouchers'::regclass)
  AND contype IN ('c', 'f')

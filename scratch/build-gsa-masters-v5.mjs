...
const out=path.join(base,'masters-v5');
fs.mkdirSync(out,{recursive:true});
const files=fs.readdirSync(cand).filter(x=>x.endsWith('.mp4')).sort();
const by=n=>path.join(cand,files[n-1]);
const map=[
 ['gsa-misterios',2,1],['gsa-planeta-terra',4,3],['gsa-desenhos',5,5],['gsa-sessao-pipoca',8,8],['gsa-cinema',10,9],['gsa-esportes',12,11],['gsa-ta-na-rede',14,13],['gsa-music',16,16],['gsa-hora-da-palavra',18,17],['gsa-historias-da-biblia',20,19],['gsa-em-fe',22,26],['gsa-sabor',24,23],['gsa-bem-viver',28,27],['gsa-destinos',30,29],['gsa-mundo',31,33],['gsa-agro',34,32],['gsa-motor',36,35],['gsa-tech',37,37],['gsa-business',43,40],['gsa-cidadania',44,39],['gsa-tempo',45,42],['gsa-meio-dia-news',47,46],['gsa-manha-news',48,48],['gsa-news-noite',41,38],['gsa-mercado',50,50]
];

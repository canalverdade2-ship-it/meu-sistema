-- 20260716183010_update_checkout_function.sql
-- Atualiza a função de checkout segura no banco de dados para suportar descontos individuais nos produtos
...
BEGIN
  ...
  LOOP
    IF v_item ->> 'tipo' = 'produto' THEN
      ...
      -- Calcular preços com Desconto Individual (Trigger garante a consistência de valor_promocional)

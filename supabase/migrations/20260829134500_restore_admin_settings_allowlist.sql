...
AS $$
  SELECT ARRAY[
    ...
    'cobranca_juros_mensal','cobranca_juros_tipo',
    'loja_pix_desconto_ativo','loja_pix_desconto_porcentagem','loja_pix_desconto_tipo_aplicacao',
    'loja_pix_desconto_categorias','loja_pix_desconto_produtos','loja_pix_desconto_permitir_pontos',
    ...
    'credito_saque_taxa_tipo','credito_saque_taxa_valor'
  ]::text[];
$$;

...
BEGIN
  ...
  -- Bypass interno e transacional: a sessao e a titularidade ja foram validadas.
  -- Isso permite apenas que esta RPC SECURITY DEFINER gere o aviso ao admin,
  -- sem abrir INSERT administrativo direto para o cliente.
  ...
  INSERT INTO public.notificacoes(
    ...
    jsonb_build_object(
      ...
      'cliente_id', v_actor.cliente_id,
      'limite_solicitado', v_request.limite_solicitado
    )
  );

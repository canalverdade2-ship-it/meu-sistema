...
-- 1. Adiciona coluna redemption_delay_24h na tabela parceiros
ALTER TABLE public.parceiros
  ADD COLUMN IF NOT EXISTS redemption_delay_24h boolean NOT NULL DEFAULT false;

-- 2. Atualiza a função pública com suporte ao retorno de delay_24h
...
BEGIN
  ...
  INSERT INTO public.parceiros_resgates (
    ...
    CASE WHEN COALESCE(v_partner.redemption_delay_24h, false) THEN 'pendente' ELSE 'concluido' END,
